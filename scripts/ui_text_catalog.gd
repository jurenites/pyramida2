...
const CITIZEN_SAWING_PLANK_STATUS_TEXT := "citizen_sawing_plank_status_text"
const CITIZEN_PLANK_COMPLETE_STATUS_TEXT := "citizen_plank_complete_status_text"
const CITIZEN_SAWMILL_NEEDS_LOG_STATUS_TEXT := "citizen_sawmill_needs_log_status_text"
